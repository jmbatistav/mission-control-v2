...
function PipelinePage() {
    ...
    const getItems = (stageKey)=>{
        switch(stageKey){
            case "ideas":
                return ideas.filter((i)=>[
                        "draft",
                        "approved"
                    ].includes(i.status)).map((i)=>({
                        id: i._id,
                        title: i.title,
                        status: i.status,
                        priority: i.priority,
                        assignee: i.createdBy,
                        type: "idea"
                    }));
            case "specs":
                return specs.filter((s)=>[
                        ...
                        "review",
                        "approved"
                    ].includes(s.status)).map((s)=>({
                        id: s._id,
                        title: s.title,
                        status: s.status,
                        assignee: s.createdBy,
                        type: "spec"
                    }));
            case "tasks":
                ...
                children: stages.map((stage, idx)=>{
                    ...
                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            idx < stages.length - 1 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=_02e2b890._.js.map